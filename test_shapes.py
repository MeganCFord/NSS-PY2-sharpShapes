...
class Test_shapes(unittest.TestCase):
    ...
    def test_rectangle_structure(self):
        test_rectangle = Rectangle(2, 2)
        test_rectangle.calculate_area()
    ...
    def test_rhombus_structure(self):
        test_rhombus = Rhombus(2, 2)
        test_rhombus.calculate_area()
    ...
    def test_parallelogram_structure(self):
        test_parallelogram = Parallelogram(2, 2)
        test_parallelogram.calculate_area()
    ...
    def test_triangle_structure(self):
        test_triangle = Triangle(4, 2)
        test_triangle.calculate_area()
    ...
    def test_pyramid_structure(self):
        test_pyramid = Pyramid(2, 2, 2)
        test_pyramid.calculate_volume()
    ...
    def test_cylinder_structure(self):
        test_cylinder = Cylinder(2, 4)
        test_cylinder.calculate_volume()
    ...
    def test_block_structure(self):
        test_block = Block(3, 3, 3)
        test_block.calculate_volume()
